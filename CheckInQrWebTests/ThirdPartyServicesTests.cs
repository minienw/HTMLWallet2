...
namespace CheckIn.Shared.Tests
{
    ...
    {
        private const string QrCodeContentsBase64_Identity_localhost_8081 = "";
        ...
        public WorkFlowTestsTests()
        {
            ...
            _Logger = _LoggerFactory.CreateLogger<VerificationWorkflow>();
    ...
    public class ThirdPartyServicesTests
    {
        ...
        public void Validate()
        {
            ...
            var dbp = new Moq.Mock<IDialogService>();
            dbp.Setup(x => x.ShowMessageBox(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), null)).Returns(() => Task.FromResult<bool?>(true));

            var loggerFactory = LoggerFactory.Create(builder => builder.AddConsole());
            var logger = loggerFactory.CreateLogger<VerificationWorkflow>();
            ...
            workflow.ValidateDccAsync(Dcc).GetAwaiter().GetResult();
