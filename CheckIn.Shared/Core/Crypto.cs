...
public static class Crypto
{
    ...
    public static bool Verify(byte[] payload, byte[] signature, AsymmetricKeyParameter publicKey)
    {
    ...
    public static byte[] Sign(byte[] payload, AsymmetricKeyParameter privateKey)
    {
